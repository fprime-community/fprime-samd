module Samd21 {
    ...
    passive component StaticCmdDispatcher {
        ...
        @ Received a NO_OP command
        event UnexpectedCommandResponse(
            opCode: FwOpcodeType
            cmdSeq: U32
