...
class ThinBufferManager final : public ThinBufferManagerComponentBase {
  ...
  public:
    ...
    //!
    ThinBufferManager(const char* const compName /*!< The component name*/
    );
